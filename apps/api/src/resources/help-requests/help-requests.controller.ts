...
export class HelpRequestsController {
  ...
  @ApiOperation({
    ...
    description:
      "Allows Business Owners to request assistance from the 247GBS support team. The request is synced to the central hub and assigned to an agent.",
  })
  @ApiBody({
    ...
    examples: {
      campaignHelp: {
        ...
        value: {
          ...
          description:
            "I need help setting up a double points campaign for the upcoming summer sale starting next week.",
        },
      },
      rewardHelp: {
        ...
        value: {
          ...
          description:
            "Please help me create a reward that gives a free coffee for 500 points, available only to Gold Tier members.",
        },
      },
    },
  })
  @ApiResponse({
    status: 201,
    description:
      "Help request successfully submitted and queued for assignment.",
    schema: {
      example: {
