...
const EditStaffPage = () => {
  ...
  const { data: staff, isLoading, isError, error } = useGetStaffById(staffId, businessId);
  const { mutate: updateStaff, isPending } = useUpdateStaff(businessId);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      updateStaff({ id: staffId, ...updateData }, {
        onSuccess: () => {
          alert('Staff member updated successfully');
          router.push(`/admin/view-business/${businessId}/staff`); // Redirect to staff list in impersonated dashboard
        },
        onError: (error) => {
