...
export class SyncEnumAndPendingChanges1769897862194 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."help_requests_type_enum" AS ENUM('CAMPAIGN_CREATION', 'CAMPAIGN_EDIT', 'CAMPAIGN_ARCHIVE', 'REWARD_CREATION', 'REWARD_EDIT', 'REWARD_ARCHIVE', 'TIER_MANAGEMENT', 'ANALYTICS_REPORT', 'GENERAL_SUPPORT')`,
    );
    await queryRunner.query(
