  ...
  switch (type) {
    case "GIFT_CARD":
      return {
        ...
        gradient: "from-indigo-900 via-purple-900 to-indigo-955",
    ...
    case "VOUCHER":
      return {
        ...
        gradient: "from-blue-900 via-cyan-900 to-blue-955",
    ...
    case "COUPON":
      return {
        ...
        gradient: "from-emerald-900 via-green-900 to-emerald-955",
    ...
    default:
      return {
        ...
        gradient: "from-[#f54900]/90 via-[#f54900]/70 to-[#ff843a]/70",
        mesh: "bg-[radial-gradient(at_0%_0%,rgba(245,73,0,0.15)_0,transparent_50%),radial-gradient(at_50%_0%,rgba(244,63,94,0.15)_0,transparent_50%)]",
        text: "text-[#f54900]",
...
export default function MallRewardsContent({
  ...
  const RewardTicket = ({ item }: { item: MallRewardHistoryRecord }) => {
    ...
    return (
      ...
      >
        <div className="flex flex-col bg-white rounded-[2rem] shadow-md border border-gray-200 overflow-hidden h-full transition-all duration-500 relative">
          ...
          <div className={`relative h-48 overflow-hidden bg-gradient-to-br ${styles.gradient}`}>
            ...
            <div className="absolute top-3 left-3 z-20">
              <Badge className="bg-gray-900/90 backdrop-blur-md text-white border-none px-3 py-1 rounded-full shadow-lg flex items-center gap-1.5 text-[9px] font-black tracking-widest uppercase">
                <div className="w-1.5 h-1.5 rounded-full bg-[#f54900] animate-pulse" />
                {styles.label}
              </Badge>
            </div>
            ...
            <div className="absolute bottom-0 right-0 p-3 transform translate-y-2 translate-x-2">
              <div className="relative">
                <div className="absolute inset-0 bg-[#f54900]/20 blur-xl rounded-full translate-y-2" />
                <div className="bg-white px-4 py-2.5 rounded-2xl shadow-xl relative border border-gray-100">
                  <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest leading-none mb-1 text-center">Value</p>
                  <p className="text-lg font-black text-[#f54900] leading-none tracking-tight">
          ...
          {/* Ticket Body */}
          <div className="p-5 pt-6 flex flex-col flex-1 relative bg-white text-gray-800">
            {/* Real Perforation Cutouts matching the page background #f9fafb */}
            <div className="absolute -top-3 -left-3 w-6 h-6 bg-[#f9fafb] rounded-full shadow-inner z-20 flex items-center justify-center overflow-hidden" />
            <div className="absolute -top-3 -right-3 w-6 h-6 bg-[#f9fafb] rounded-full shadow-inner z-20 flex items-center justify-center overflow-hidden" />

            {/* Perforated Divider Line */}
            <div className="absolute top-0 left-5 right-5 h-[2px] border-t-2 border-dashed border-gray-200 -translate-y-[1px]" />

            <div className="space-y-4 flex-1 flex flex-col">
              <div>
                <motion.h3 className="font-black text-gray-900 text-[15px] leading-tight group-hover:text-[#f54900] transition-all duration-300 line-clamp-2">
                  {reward.title}
                </motion.h3>
                <div className="flex items-center gap-2 mt-3">
                  <div className="w-7 h-7 rounded-lg bg-gray-50 flex items-center justify-center border border-gray-100 group-hover:border-orange-200 transition-colors shadow-sm">
                    <Store size={12} className="text-gray-405 group-hover:text-[#f54900]" />
                  </div>
                  <div className="flex flex-col">
                    <span className="text-[9px] uppercase font-black text-gray-405 leading-none mb-0.5">Store / Partner</span>
              ...
              <div className="mt-auto space-y-3">
                <div className="p-3 rounded-2xl bg-gray-50 border border-dashed border-gray-200 group-hover:border-orange-200 transition-all duration-500 relative overflow-hidden">
                  ...
                  <div className="relative z-10 flex items-center justify-between gap-3">
                    <div className="flex flex-col">
                      ...
                      <code className="text-base font-mono font-black text-gray-900 tracking-wider group-hover:text-[#f54900] transition-colors">
                    ...
                    <Button
                      variant="ghost"
                      size="icon"
                      className="w-8 h-8 rounded-lg bg-white shadow-sm border border-gray-200 text-gray-500 hover:text-[#f54900] hover:border-orange-200 hover:translate-y-[-2px] transition-all"
                      onClick={(e) => {
                        e.stopPropagation();
                ...
                <div className="flex items-center justify-between text-[10px] font-bold">
                  ...
                  <div className="flex items-center gap-1 text-emerald-600 py-1 px-2 bg-emerald-50 rounded-lg border border-emerald-200">
          ...
          <div className="px-5 pb-5 bg-white">
            <Button
              className="w-full h-11 rounded-xl bg-gray-50 hover:bg-[#f54900] border border-gray-150 hover:border-none text-gray-700 hover:text-white font-black text-[11px] uppercase tracking-widest shadow-md transition-all duration-300 group/btn"
            >
              <span className="flex-1 text-left">View Full Ticket</span>
              <div className="w-6 h-6 rounded-lg bg-gray-200/50 flex items-center justify-center group-hover/btn:translate-x-1 transition-transform">
  ...
  const EmptyState = ({ type }: { type: string }) => (
    <motion.div
      ...
      className="max-w-xl mx-auto py-24 px-8 text-center bg-white rounded-[3rem] border border-dashed border-gray-300 relative overflow-hidden"
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(245,73,0,0.05)_0,transparent_70%)]" />
      <div className="relative mb-10">
        <div className="w-24 h-24 bg-orange-50 rounded-full flex items-center justify-center mx-auto relative border border-orange-100">
          <div className="absolute inset-0 bg-orange-100 rounded-full animate-ping" />
          <Gift size={40} className="text-[#f54900] relative z-10" />
        </div>
      </div>
      ...
      <Button
        variant="outline"
        className="h-14 px-10 rounded-2xl border-[#f54900] text-[#f54900] hover:bg-orange-50 font-black text-sm uppercase tracking-widest bg-transparent"
        onClick={() => refetch()}
      >
        Scan for Rewards
      </Button>
  ...
  return (
    <div className="min-h-screen bg-[#f9fafb] text-gray-800 p-4 md:p-8">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 pt-6">
          <div className="space-y-4">
            <motion.div
              ...
              className="flex items-center gap-3 px-4 py-2 rounded-2xl bg-[#f54900] shadow-lg shadow-orange-500/20 text-white w-fit font-bold"
            >
            ...
            >
              My <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#f54900] to-[#ff843a]">Treasures</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.2 }}
              className="text-gray-500 text-xl font-bold max-w-2xl leading-relaxed"
            >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <div className="flex -space-x-4">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="w-12 h-12 rounded-full border-4 border-white bg-gray-150 flex items-center justify-center overflow-hidden">
                  <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${i + 10}`} alt="user" />
                </div>
              ))}
              <div className="w-12 h-12 rounded-full border-4 border-white bg-[#f54900] text-white flex items-center justify-center text-xs font-black">
                +12k
              </div>
            </div>
        ...
        <div className="grid lg:grid-cols-4 gap-6 items-center">
          <div className="lg:col-span-3 relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-[#f54900] to-[#f54900]/80 rounded-3xl blur opacity-10 group-focus-within:opacity-25 transition-opacity duration-300" />
            <div className="relative flex items-center bg-white border border-gray-200 rounded-[2rem] shadow-sm px-6 py-2">
              <Search className="text-gray-400 w-6 h-6 mr-4" />
              <Input
                placeholder="Search vouchers, stores, or distribution codes..."
                value={search}
                onChange={(e) => setSearch(e.target.value)}
                className="border-none focus:ring-0 text-lg font-bold placeholder:text-gray-400 h-14 bg-transparent outline-none shadow-none text-gray-800"
              />
              <div className="hidden md:flex gap-2">
                <Badge className="bg-gray-100 text-gray-500 border-none rounded-xl px-4 py-2 font-black text-[10px] tracking-widest uppercase">Esc</Badge>
                <Badge className="bg-[#f54900] text-white border-none rounded-xl px-4 py-2 font-black text-[10px] tracking-widest uppercase shadow-lg">/</Badge>
              </div>
            </div>
          </div>
          <Button
            variant="outline"
            className="h-16 rounded-[2.5rem] border-gray-200 bg-white hover:bg-gray-50 hover:border-[#f54900] text-gray-700 shadow-sm transition-all duration-300 font-black text-sm uppercase tracking-widest px-8"
            onClick={() => refetch()}
          >
          ...
          <Button
            className="h-16 rounded-[2.5rem] bg-[#f54900] hover:bg-[#f54900]/95 text-white shadow-lg shadow-orange-500/20 transition-all duration-300 font-black text-sm uppercase tracking-widest px-8 group border-none"
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 overflow-x-auto pb-2 scrollbar-hide">
            <TabsList className="bg-transparent h-auto p-0 gap-8 justify-start">
              <TabsTrigger value="all-rewards" className="relative h-12 px-0 bg-transparent text-gray-400 data-[state=active]:text-gray-900 border-none rounded-none text-2xl font-black transition-all group">
                ...
                <div className="absolute -bottom-2 left-0 w-0 h-1.5 bg-[#f54900] rounded-full transition-all duration-300 group-data-[state=active]:w-full" />
              </TabsTrigger>
            ...
            <div className="flex items-center gap-4 bg-white px-6 py-3 rounded-2xl border border-gray-200">
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-[#f54900] animate-pulse" />
          ...
          <AnimatePresence mode="wait">
            {isError ? (
              <motion.div
                ...
                className="py-12"
              >
                <div className="max-w-xl mx-auto bg-white rounded-[3rem] border border-gray-200 p-12 text-center shadow-xl">
                  <div className="w-20 h-20 bg-red-50/50 border border-red-200 rounded-3xl flex items-center justify-center mx-auto mb-6">
                  ...
                  <Button
                    className="bg-[#f54900] hover:bg-[#f54900]/95 text-white rounded-2xl px-12 h-14 font-black text-sm uppercase tracking-widest border-none"
                    onClick={() => refetch()}
                  >
                    Restore connection
                  </Button>
        ...
        {!isLoading && history.length > 0 && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="flex flex-col sm:flex-row items-center justify-between bg-white p-8 rounded-[3rem] border border-gray-200 shadow-2xl relative animate-none"
          >
            <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#f54900]/20 to-transparent" />

            <div className="flex items-center gap-6 mb-8 sm:mb-0">
              <div className="w-16 h-16 rounded-[1.5rem] bg-gray-50 border border-gray-100 flex items-center justify-center relative">
                <div className="absolute inset-0 bg-[#f54900] opacity-5 rounded-[1.5rem] animate-pulse" />
                <LayoutGrid size={24} className="text-[#f54900] relative z-10" />
              </div>
              <div>
            ...
            <div className="flex items-center gap-4 w-full sm:w-auto">
              <Button
                variant="outline"
                className="flex-1 sm:flex-none rounded-2xl h-16 px-10 border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-black text-xs uppercase tracking-widest disabled:opacity-30"
                disabled={page === 1}
              ...
              <Button
                variant="outline"
                className="flex-1 sm:flex-none rounded-2xl h-16 px-10 border-gray-200 bg-white hover:bg-gray-55 text-gray-750 font-black text-xs uppercase tracking-widest disabled:opacity-30"
      ...
      <div className="fixed top-0 right-0 w-[800px] h-[800px] bg-[#f54900]/5 blur-[120px] rounded-full -translate-y-1/2 translate-x-1/2 -z-10 pointer-events-none" />
      <div className="fixed bottom-0 left-0 w-[600px] h-[600px] bg-blue-500/5 blur-[100px] rounded-full translate-y-1/2 -translate-x-1/2 -z-10 pointer-events-none" />
    </div>
  );
}
