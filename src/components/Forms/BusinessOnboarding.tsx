...
export default function BusinessOnboardingWizard() {
  ...
  const {mutate: onboardBusiness, isPending} = useBusinessOnboard();
 ...
 const stepFields: Record<
  number,
  ("sectorId" | "email" | "phone" | "address" | "website" | "socialMedia" | "referralCapacity" | "socialMedia.facebook" | "socialMedia.twitter" | "socialMedia.instagram")[]
> = {
  1: ["sectorId", "email", "phone"],
...
const handleNext = async () => {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50 overflow-y-hidden">
      {/* LEFT SIDE */}
      <div className="hidden md:flex w-1/2 flex-col justify-center items-center bg-indigo-600 text-white p-10">
                ...
                >
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <div className="flex justify-between">
                      ...
                      <Button disabled={isPending} type="submit" className="bg-indigo-600 hover:bg-indigo-700">
