...
export default function Footer() {
  return (
    <footer className="bg-white border-t border-gray-200 py-12 px-6 md:px-8 mt-auto relative z-10">
      <div className="max-w-7xl mx-auto w-full space-y-8">
        
        {/* Row 1: Brand Logo & Navigation Links */}
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6 pb-8 border-b border-gray-150">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-xs font-semibold text-gray-400 uppercase tracking-wider">
          ...
          {/* Social Media Links */}
          <div className="flex gap-5 text-gray-450">
