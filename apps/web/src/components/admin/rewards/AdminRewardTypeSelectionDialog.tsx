...
import { RewardType } from './UnifiedRewardWizardModal';

interface AdminRewardTypeSelectionDialogProps {
    isOpen: boolean;
    onClose: () => void;
    onContinue: (selectedTypes: RewardType[]) => void;
}

export default function AdminRewardTypeSelectionDialog({
    isOpen,
    onClose,
    onContinue,
}: AdminRewardTypeSelectionDialogProps) {
