    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="fixed top-0 right-0 h-full w-full md:w-96 bg-white dark:bg-zinc-950 border-l border-zinc-200 dark:border-zinc-800 z-[50] shadow-2xl flex flex-col"
            >
                <Card className="w-full h-full border-zinc-200 dark:border-zinc-800 shadow-2xl rounded-3xl overflow-hidden flex flex-col bg-white/95 dark:bg-zinc-900/95 backdrop-blur-md">
                    ...
                    <CardContent className="flex-1 overflow-y-auto px-6 -mt-10 space-y-6 pb-20">
                        ...
                        {selectedCircle?.type === 'SMART_MONEY' || selectedCircle?.type.toLowerCase() === 'finance' ? (
                            ...
                            <div className="p-5 bg-orange-600 rounded-3xl text-white relative overflow-hidden group shadow-xl shadow-orange-500/20">
                                <div className="absolute right-0 top-0 w-24 h-24 bg-white/10 blur-3xl rounded-full" />
                                <h4 className="font-bold text-sm flex items-center gap-2 mb-4">
                                    <Star className="w-4 h-4 text-orange-200 fill-orange-200" /> Collaboration Impact
                                </h4>
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center bg-black/10 backdrop-blur-sm p-2 rounded-xl">
                                        <span className="text-xs opacity-80">Earned Points</span>
                                        <span className="font-black text-sm uppercase tracking-wider">{activeMember.earnedPoints || 0} PTS</span>
                                    </div>
                                    <div className="flex justify-between items-center bg-black/10 backdrop-blur-sm p-2 rounded-xl">
                                        <span className="text-xs opacity-80">Offers Distributed</span>
                                        <span className="font-black text-sm uppercase tracking-wider">{activeMember.distributions || 0}</span>
                                    </div>
                                </div>
                            </div>
                        )}
