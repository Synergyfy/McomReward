...
export class PlanTierLevel extends AbstractBaseEntity {
  ...
  @ApiProperty({
    description:
      "Display sort order (1 for STANDARD, 2 for PRO, 3 for PRO_PLUS)",
  })
  ...
  @ApiProperty({
    description:
      "Fixed duration in days (90 for STANDARD, 180 for PRO, null for 1 calendar year)",
    nullable: true,
  })
  ...
  @ApiProperty({
    description:
      "Flag indicating duration is exactly 1 calendar year (leap-safe)",
  })
