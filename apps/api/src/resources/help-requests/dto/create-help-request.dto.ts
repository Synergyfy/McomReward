...
export class CreateHelpRequestDto {
  ...
  @ApiProperty({
    description:
      "A detailed explanation of what assistance is needed. You can include specific requirements, dates, or questions.",
    example:
      "I need to set up a campaign that runs from Dec 20 to Dec 25. It should offer double points on all coffee purchases. Please check my tier settings as well.",
  })
  @IsString()
  @IsNotEmpty()
  description: string;
