...
export default function BusinessDashboard() {
  ...
  const { data: analyticsData, isLoading: isAnalyticsLoading, isError: isAnalyticsError } = useGetGeneralAnalytics(businessId);
  const { data: chartData, isLoading: isChartLoading, isError: isChartError } = useGetChartData({ period: timeRange, businessId });
  const { data: subscription, isLoading: isLoadingSubscription } = useGetMySubscription(businessId); // Pass businessId here
