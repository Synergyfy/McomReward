...
export default function MyPointsPage() {
  ...
  // REPLACE with this code to force redirection if not a member
if (!isMember) {
  // Use a redirect to send the user back to the campaign list
  // or a login page, as intended by the original flow.
